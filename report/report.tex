...
\begin{figure*}[tbp]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      table[ybar, col sep=comma, x=INPUT-SIZE, y=RELATIVE] {../plots_lib/all.csv};
      \addplot+[discard if not={NAME}{ethSIFT avx icc full chrono Histogram}]
      table[ybar, col sep=comma, x=INPUT-SIZE, y=RELATIVE] {../plots_lib/all.csv};
      \addplot+[discard if not={NAME}{ethSIFT avx icc full chrono ExtremaRefinement}]
      table[ybar, col sep=comma, x=INPUT-SIZE, y=RELATIVE] {../plots_lib/all.csv};
      ...
      table[ybar, col sep=comma, x=INPUT-SIZE, y=RELATIVE] {../plots_lib/all.csv};
      \legend{\strut Gaussians, \strut Gradients, \strut Histogram, \strut Extrema, \strut Kepyoint, \strut Descriptor, \strut DOG}
    \end{axis}
  \end{tikzpicture}
  \caption{Relative runtime of individual algorithm steps over input size}
  \label{fig:relative}
\end{figure*}
