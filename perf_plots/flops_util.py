...
flops_util['eth']['GradientAndRotationPyramids'] = lambda w, h: calc_octave_count * 3 * w * h * (2 + (4 * calc_get_pixel_f) + sqrt_flops + calc_fast_ata2f_worst_case)
